...
<template>
    <div rounded-1 text-10px sm:text-14px shadow="~ dark/5" b="solid 1px dark:white/10 dark/10 t-dark/5 dark:t-white/20" flex items-center bg="white dark:dark-1" op-90 text-color hover:op-100 hover:translate-y--2px active:translate-y-1px active:op-80 active:shadow-none transition cursor-pointer @click="onSettingClick">
        ...
        <div px-6px py-7px bg="dark/4 dark:white/10 hover:dark/10 hover:dark:white/20" transition rounded-r-1 mr-3px h-6 sm:h-7 @click.stop="onRemoveClick">
            <div i-tabler-x />
        </div>
    </div>
</template>
